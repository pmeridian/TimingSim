...
CCalTdetOrganization::~CCalTdetOrganization(){
  G4cout << " Deleting CCalTdetOrganization" << G4endl;
}


unsigned int CCalTdetOrganization::GetUnitID(const G4Step* aStep) const {
